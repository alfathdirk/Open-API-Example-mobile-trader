...
import 'package:myfxhistory_app/screens/special_thanks_terms.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: <Widget>[
          ...
          _item(
              context, 'https://pub.dev/packages/flutter_localization', 'bsd3'),
          _item(context, 'https://pub.dev/packages/flutter_native_timezone',
              'flutter_native_timezone'),
          _item(context, 'https://pub.dev/packages/flutter_secure_storage',
              'bsd3'),
          ...
          _item(context, 'https://pub.dev/packages/shared_preferences',
              'bsd3clause'),
          _item(context, 'https://pub.dev/packages/timezone', 'bsd2clause'),
          _item(context, 'https://pub.dev/packages/url_launcher', 'bsd3clause'),
          _item(context, 'https://pub.dev/packages/visibility_detector',
              'bsd3clause'),
          _item(context, 'https://pub.dev/packages/webview_flutter',
              'bsd3clause'),
        ]),
      ),
    );
      ...
      child: Padding(
        ...
        child: Row(children: <Widget>[
          ...
          SvgPicture.asset('assets/svg/arrow_greater.svg',
              width: 5, height: 10, colorFilter: THEME.onBackground().asFilter),
        ]),
      ),
    );
  }
  ...
  void _onTapItem(BuildContext context, String type) {
    Navigator.push(
        ...
        MaterialPageRoute<void>(
            builder: (BuildContext context) => SpecialThanksTerms(type: type)));
  }
}
