...
class TextStyles {
  TextStyles.colorizedBy({required IThemeConfig config}) {
    ...
    bodyRegularSecondary =
        bodyRegular.copyWith(color: config.onBackgroundSecondary());
    bodyMedium = bodyMedium.copyWith(color: config.onBackground());
    bodyMediumSecondary =
        bodyMedium.copyWith(color: config.onBackgroundSecondary());
    ...
    bannerBotom =
        bannerBotom.copyWith(color: config.bannerBottonOnBackground());
    bannerBottomSecondary = bannerBottomSecondary.copyWith(
        color: config.bannerBottonOnBackgroundSecond());

    buttonPrimary = buttonPrimary.copyWith(color: config.buttonPrimaryText());
    buttonSecondary =
        buttonSecondary.copyWith(color: config.buttonSecondaryText());
    buttonThird = buttonThird.copyWith(color: config.buttonThirdText());

    input = input.copyWith(color: config.inputText());
    inputIncremenet =
        inputIncremenet.copyWith(color: config.inputIncrementText());

    sideMenu = sideMenu.copyWith(color: config.menuText());
    sideMenuSecondary = sideMenu.copyWith(color: config.menuTextSecondary());
    sideMenuActivityCircles =
        sideMenu.copyWith(color: config.menuActivityCircleText());

    chartRotateTip =
        chartRotateTip.copyWith(color: config.chartBlockOnBackground());
  }
