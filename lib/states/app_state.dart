...
class AppState extends ChangeNotifier {
  ...
  Future<void> _saveState() async {
    ...
    prefs.setBool(AppStateKeys.moreAccountsWarnPopup.toString(),
        _moreAccountsWarnPopupShowed);
  ...
  Future<void> _restoreState() async {
    ...
    _themeType = ThemeType.values.elementAt(
        prefs.getInt(AppStateKeys.theme.toString()) ?? _themeType.index);
    _floatingPnl = FloatingPnlState.values.elementAt(
        prefs.getInt(AppStateKeys.pnlState.toString()) ?? _floatingPnl.index);
    _showOrdersInMarket = prefs.getBool(AppStateKeys.showOrders.toString()) ??
        _showOrdersInMarket;
    _chartHeight =
        prefs.getDouble(AppStateKeys.chartHeight.toString()) ?? _chartHeight;
    _moreAccountsWarnPopupShowed =
        prefs.getBool(AppStateKeys.moreAccountsWarnPopup.toString()) == true;
    _termsChecked = prefs.getBool(AppStateKeys.termsChecked.toString()) == true;
    _trTermsChecked =
        prefs.getBool(AppStateKeys.trTermsChecked.toString()) == true;
