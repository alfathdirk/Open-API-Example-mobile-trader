...
class Popup extends StatefulWidget {
  const Popup({
    ...
    this.buttonsAxis,
            ...
            'message or content param should be provided');
...
class _PopupState extends State<Popup> {
  ...
  List<Widget> popupContent() {
    if (widget.message != null)
      return <Widget>[
        Text(widget.message!, style: popup_constants.textStyleBody)
      ];
        ...
        child: Row(
          ...
          children: <Widget>[
            WrappedCheckbox(
              ...
              onTap: () => setState(() =>
                  widget.payload[Popup.PAYLOAD_CHECKBOX_KEY] =
                      !(widget.payload[Popup.PAYLOAD_CHECKBOX_KEY] == true)),
            ),
  ...
  Widget popupButtons() {
    if (widget.buttons != null && widget.buttons!.isNotEmpty) {
      return Flex(
          direction: widget.buttonsAxis ?? Axis.horizontal,
