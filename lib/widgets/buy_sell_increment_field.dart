...
import 'package:myfxhistory_app/widgets/numeric_field.dart';
...
class _BuySellIncrementFieldState extends State<BuySellIncrementField> {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
      _button(
          SvgPicture.asset(
            ...
            width: 8,
            colorFilter: (widget.minusButtonDisabled == true
      ...
      SizedBox(
          ...
          child: NumericField(
            value: widget.value != null
                ? widget.value!.toComaSeparated(decimals: widget.decimals ?? 0)
                : '----',
      ...
      _button(
          SvgPicture.asset(
            'assets/svg/plus.svg',
            width: 10,
            colorFilter: (widget.plusButtonDisabled == true
                    ? THEME.inputBorderDisabled()
                    : THEME.onBackground())
                .asFilter,
          ),
    ...
    return GestureDetector(
      ...
      onLongPressStart: (LongPressStartDetails details) {
        ...
        _longPressTimer =
          ...
          final int delta =
              (DateTime.now().millisecondsSinceEpoch - (_longPressTS ?? 0)) ~/
                  100 *
                  100;
  ...
  void _onChangeValue(double value) {
    ...
    widget.onChange(min(widget.maxVolume ?? double.infinity,
        max(widget.minVolume ?? 0, amount)));
  }
}
