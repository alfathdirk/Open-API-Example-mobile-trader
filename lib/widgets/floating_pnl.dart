...
class _FloatingPnlState extends State<FloatingPnl>
  ...
  void initState() {
    ...
    _manualAnimation =
        Tween<double>(begin: -0.25, end: -1.25).animate(_manualController);
    _manualController.animateTo(
        <double>[0, 0.25, 0.75][GetIt.I<AppState>().floatingPnlState.index]);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Color bgColor = isExpanded
        ? THEME.floatingPnlLargeBackground()
        : (trader.pnl < 0 ? THEME.red : THEME.green);
    final Color colorOnBg = isExpanded
        ? THEME.floatingPnlLargeOnBackground()
        : THEME.floatingPnlSmallOnBackground();
              ...
              child: AnimatedSize(
                ...
                child: IntrinsicHeight(
                  child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                    ...
                    if (!isHide && isExpanded)
                      for (final Widget item in _expandedFilling(l10n, trader))
                        item,
                    Container(
                      width: 1,
                      color: isExpanded
                          ? THEME.floatingPnlLargeDivider()
                          : bgColor,
                    ...
                    Container(
                      alignment:
                          isExpanded ? Alignment.topCenter : Alignment.center,
    ...
    return <Widget>[
      ...
      Text(
        ...
        style: THEME.texts.bodyMedium
            .copyWith(color: THEME.floatingPnlSmallOnBackground()),
      ),
    ];
  }

  List<Widget> _expandedFilling(AppLocalizations l10n, TraderData trader) {
    final TextStyle textStyle = THEME.texts.bodyMedium
        .copyWith(color: THEME.floatingPnlLargeOnBackground());
        ...
        child: Column(children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              const SizedBox(width: 12),
              Text(trader.formattedMoneyWithCurrency(cents: trader.balance),
                  style: textStyle),
            ],
          ),
          Row(
            ...
            children: <Widget>[
              ...
              const SizedBox(width: 12),
              Text(trader.formattedMoneyWithCurrency(cents: trader.equity),
                  style: textStyle),
            ],
          ),
          Row(
            ...
            children: <Widget>[
              ...
              const SizedBox(width: 12),
              Text(trader.formattedMoneyWithCurrency(cents: trader.margin),
                  style: textStyle),
            ],
          ),
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                ...
                style: textStyle.copyWith(
                    color: trader.pnl < 0 ? THEME.red : THEME.green),
              )
            ],
          ),
          const SizedBox(height: 8),
